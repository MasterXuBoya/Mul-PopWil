...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SystemSettings_t, stringdata) + ofs \
...
const QMetaObject SystemSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SystemSettings.data,
      qt_meta_data_SystemSettings,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SystemSettings.stringdata))
