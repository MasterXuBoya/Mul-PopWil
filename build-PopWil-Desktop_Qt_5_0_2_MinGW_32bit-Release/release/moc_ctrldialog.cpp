...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CtrlDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 62, 5)
    ...
    "on_btnQuit_clicked\0DeviceChanged\0index\0"
};
...
const QMetaObject CtrlDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CtrlDialog.data,
      qt_meta_data_CtrlDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CtrlDialog.stringdata))
