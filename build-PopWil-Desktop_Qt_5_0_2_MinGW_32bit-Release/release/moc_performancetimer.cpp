...
#include "../../PopWil/Tool/performancetimer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PerformanceTimer_t, stringdata) + ofs \
...
const QMetaObject PerformanceTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PerformanceTimer.data,
      qt_meta_data_PerformanceTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PerformanceTimer.stringdata))
