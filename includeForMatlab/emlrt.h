 ...
 */
#define EMLRT_VERSION_R2015B 0x2015B
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2015B
...
/*
 * MATLAB INTERNAL USE ONLY :: Clear runtime error status
 */
EXTERN_C LIBEMLRT_API void emlrtClearErrorStatus(emlrtConstCTX aTLS);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtBreakSimulation(emlrtCTX aCtx);
EXTERN_C LIBEMLRT_API bool emlrtErrorIsBreakSimulation(emlrtCTX aCtx);
