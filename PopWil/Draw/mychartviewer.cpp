...
//---------------------------------参数初始化------------------------------------------------------------
    ...
    m_ChartUpdateTimer = new QTimer(m_ChartViewer);
...
void MyChartViewer::start(){
    m_ChartUpdateTimer->start(systemInfo.drawInterval);//绘图定时器开启
}

void MyChartViewer::stop(){
    m_ChartUpdateTimer->stop();
}
// The Pointer, Zoom In or Zoom out button is pressed
///0,1,2表示正常、放大、缩小，只要传参数进去即可
void MyChartViewer::onMouseUsageChanged(int mouseUsage)
{
...
void MyChartViewer::onChartUpdateTimer()
{
...
void MyChartViewer::onViewPortChanged()
{
...
// Draw chart
void MyChartViewer::drawChart(QChartViewer *viewer)
{
...
void MyChartViewer::onMouseMovePlotArea(QMouseEvent *)
{
...
double MyChartViewer::trackLineLabel(XYChart *c, int mouseX)
{
...
// Draw the full thumbnail chart and display it in the given QViewPortContro
void MyChartViewer::drawFullChart(QViewPortControl *vpc)
{
    // Create an XYChart object of size 640 x 60 pixels
    XYChart *c = new XYChart(640, 80);
